...
CREATE TABLE Katalog_Pausenzeiten (
  ...
  Bezeichnung nvarchar(40) DEFAULT 'Pause' NOT NULL,
...
CREATE TABLE SchuleOAuthSecrets (
  ID bigint NOT NULL, 
  AuthServer nvarchar(255) NOT NULL, 
...
CREATE TABLE LehrerNotenmodulCredentials (
  Lehrer_ID bigint NOT NULL, 
  Initialkennwort nvarchar(255) NOT NULL, 
...
CREATE TABLE EnmLeistungsdaten (
  ...
  tsNotenKrzQuartal datetime2 DEFAULT CURRENT_TIMESTAMP NOT NULL, 
...
CREATE TABLE EnmTeilleistungen (
  ID bigint NOT NULL, 
  tsDatum datetime2 DEFAULT CURRENT_TIMESTAMP NOT NULL, 
  tsLehrer_ID datetime2 DEFAULT CURRENT_TIMESTAMP NOT NULL, 
  tsArt_ID datetime2 DEFAULT CURRENT_TIMESTAMP NOT NULL, 
  tsBemerkung datetime2 DEFAULT CURRENT_TIMESTAMP NOT NULL, 
  tsNotenKrz datetime2 DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE Schulbewerbung_Importe (
  Schueler_ID bigint NOT NULL, 
  LastSync datetime2 DEFAULT CURRENT_TIMESTAMP NOT NULL, 
  LastXML nvarchar(max) NOT NULL,
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Benutzergruppen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
	 ...
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Benutzergruppen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Credentials'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Credentials''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''BenutzerAllgemein'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''BenutzerAllgemein''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Fachklassen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Fachklassen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_KAoADaten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_KAoADaten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Kursart'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Kursart''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Merkmale'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Merkmale''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Schulformen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Schulformen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Zertifikate'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Zertifikate''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Faecher'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Faecher''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Blockung'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Blockung''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Jahrgang_Fachkombinationen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Jahrgang_Fachkombinationen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Blockung_Kurse'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Blockung_Kurse''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Blockung_Regeln'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Blockung_Regeln''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Blockung_Schienen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Blockung_Schienen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Blockung_Zwischenergebnisse'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Blockung_Zwischenergebnisse''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Adressart'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Adressart''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Ankreuzdaten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Ankreuzdaten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Ankreuzfloskeln'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Ankreuzfloskeln''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_BeschaeftigungsArt'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_BeschaeftigungsArt''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Datenschutz'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Datenschutz''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_EinschulungsArt'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_EinschulungsArt''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Einzelleistungen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Einzelleistungen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_EntlassGrund'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_EntlassGrund''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_ErzieherArt'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_ErzieherArt''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_ErzieherFunktion'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_ErzieherFunktion''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_FahrschuelerArt'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_FahrschuelerArt''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Foerderschwerpunkt'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Foerderschwerpunkt''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Haltestelle'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Haltestelle''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Kindergarten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Kindergarten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Ort'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Ort''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Ortsteil'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Ortsteil''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_AllgAdresse'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_AllgAdresse''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''AllgAdrAnsprechpartner'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''AllgAdrAnsprechpartner''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Religion'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Religion''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Schule'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Schule''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Schulfunktionen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Schulfunktionen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Schwerpunkt'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Schwerpunkt''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Sportbefreiung'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Sportbefreiung''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_TelefonArt'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_TelefonArt''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Textdateien'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Textdateien''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Vermerkart'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Vermerkart''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Katalog_Aufsichtsbereich'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Katalog_Aufsichtsbereich''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Katalog_Pausenzeiten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Katalog_Pausenzeiten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Katalog_Raeume'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Katalog_Raeume''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Katalog_Zeitraster'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Katalog_Zeitraster''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Lernplattformen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Lernplattformen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''CredentialsLernplattformen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''CredentialsLernplattformen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''K_Lehrer'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''K_Lehrer''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Personengruppen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Personengruppen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Personengruppen_Personen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Personengruppen_Personen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchildFilter'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchildFilter''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerListe'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerListe''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Schuljahresabschnitte'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Schuljahresabschnitte''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Abteilungen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Abteilungen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Jahrgaenge'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Jahrgaenge''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''LehrerAbschnittsdaten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''LehrerAbschnittsdaten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Klassen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Klassen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Kurse'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Kurse''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''LehrerAnrechnung'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''LehrerAnrechnung''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''LehrerEntlastung'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''LehrerEntlastung''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''LehrerFunktionen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''LehrerFunktionen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''LehrerMehrleistung'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''LehrerMehrleistung''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Schueler'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Schueler''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Abt_Kl'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Abt_Kl''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerAbgaenge'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerAbgaenge''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerAbiFaecher'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerAbiFaecher''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerAbitur'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerAbitur''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerBKFaecher'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerBKFaecher''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerErzAdr'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerErzAdr''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerFHR'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerFHR''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerFHRFaecher'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerFHRFaecher''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerLernabschnittsdaten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerLernabschnittsdaten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerSprachenfolge'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerSprachenfolge''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerSprachpruefungen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerSprachpruefungen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerTelefone'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerTelefone''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerVermerke'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerVermerke''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerZP10'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerZP10''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Schueler_AllgAdr'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Schueler_AllgAdr''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Benutzer'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Benutzer''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerAnkreuzfloskeln'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerAnkreuzfloskeln''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerFehlstunden'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerFehlstunden''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerKAoADaten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerKAoADaten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerLD_PSFachBem'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerLD_PSFachBem''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerLeistungsdaten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerLeistungsdaten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''DavRessourceCollections'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''DavRessourceCollections''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''DavRessourceCollectionsACL'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''DavRessourceCollectionsACL''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerEinzelleistungen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerEinzelleistungen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''SchuelerWiedervorlage'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''SchuelerWiedervorlage''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Schulleitung'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Schulleitung''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Aufsichtsbereiche'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Aufsichtsbereiche''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Pausenzeit'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Pausenzeit''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Pausenaufsichten'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Pausenaufsichten''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_PausenaufsichtenBereich'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_PausenaufsichtenBereich''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Raeume'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Raeume''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Schienen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Schienen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Zeitraster'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Zeitraster''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Unterricht'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Unterricht''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_UnterrichtKlasse'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_UnterrichtKlasse''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_UnterrichtLehrer'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_UnterrichtLehrer''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_UnterrichtRaum'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_UnterrichtRaum''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_UnterrichtSchiene'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_UnterrichtSchiene''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Kalenderwochen_Zuordnung'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Kalenderwochen_Zuordnung''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_INSERT_Stundenplan_Pausenzeit_Klassenzuordnung ON Stundenplan_Pausenzeit_Klassenzuordnung INSTEAD OF INSERT AS
BEGIN
  DECLARE @tmpID bigint
  DECLARE @maxInsertedID bigint

  SET @maxInsertedID = (SELECT max(ID) FROM inserted WHERE ID >= 0)
  INSERT INTO Stundenplan_Pausenzeit_Klassenzuordnung
    SELECT * FROM inserted WHERE ID >= 0
    
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundenplan_Pausenzeit_Klassenzuordnung'')
  IF (@tmpID IS NULL)
    BEGIN
      SET @tmpID = (SELECT max(ID) FROM Stundenplan_Pausenzeit_Klassenzuordnung)
      IF (@tmpID IS NULL)
        BEGIN
          SET @tmpID = 0
        END
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundenplan_Pausenzeit_Klassenzuordnung''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_UPDATE_Stundenplan_Pausenzeit_Klassenzuordnung ON Stundenplan_Pausenzeit_Klassenzuordnung AFTER UPDATE AS
BEGIN
  if (UPDATE(ID))
    BEGIN
      DECLARE @tmpID bigint
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundentafel'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundentafel''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Stundentafel_Faecher'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Stundentafel_Faecher''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''DavRessources'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''DavRessources''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''ZuordnungReportvorlagen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''ZuordnungReportvorlagen''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''DavSyncTokenSchueler'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''DavSyncTokenSchueler''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''DavSyncTokenLehrer'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''DavSyncTokenLehrer''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Vorgaben'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Vorgaben''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Termine'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Termine''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Kursklausuren'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Kursklausuren''
  SET NOCOUNT OFF
END;
')
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Schuelerklausuren'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Schuelerklausuren''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Schuelerklausuren_Termine ON Gost_Klausuren_Schuelerklausuren_Termine INSTEAD OF INSERT AS
BEGIN
  DECLARE @tmpID bigint
  DECLARE @maxInsertedID bigint

  SET @maxInsertedID = (SELECT max(ID) FROM inserted WHERE ID >= 0)
  INSERT INTO Gost_Klausuren_Schuelerklausuren_Termine
    SELECT * FROM inserted WHERE ID >= 0
    
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Schuelerklausuren_Termine'')
  IF (@tmpID IS NULL)
    BEGIN
      SET @tmpID = (SELECT max(ID) FROM Gost_Klausuren_Schuelerklausuren_Termine)
      IF (@tmpID IS NULL)
        BEGIN
          SET @tmpID = 0
        END
      SET NOCOUNT ON
      INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES (''Gost_Klausuren_Schuelerklausuren_Termine'', @tmpID)
      SET NOCOUNT OFF
    END
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Schuelerklausuren_Termine''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Schuelerklausuren_Termine ON Gost_Klausuren_Schuelerklausuren_Termine AFTER UPDATE AS
BEGIN
  if (UPDATE(ID))
    BEGIN
      DECLARE @tmpID bigint
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Raeume'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Raeume''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raumstunden ON Gost_Klausuren_Raumstunden INSTEAD OF INSERT AS
BEGIN
  DECLARE @tmpID bigint
  DECLARE @maxInsertedID bigint

  SET @maxInsertedID = (SELECT max(ID) FROM inserted WHERE ID >= 0)
  INSERT INTO Gost_Klausuren_Raumstunden
    SELECT * FROM inserted WHERE ID >= 0
    
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Raumstunden'')
  IF (@tmpID IS NULL)
    BEGIN
      SET @tmpID = (SELECT max(ID) FROM Gost_Klausuren_Raumstunden)
      IF (@tmpID IS NULL)
        BEGIN
          SET @tmpID = 0
        END
      SET NOCOUNT ON
      INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES (''Gost_Klausuren_Raumstunden'', @tmpID)
      SET NOCOUNT OFF
    END
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Raumstunden''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raumstunden ON Gost_Klausuren_Raumstunden AFTER UPDATE AS
BEGIN
  if (UPDATE(ID))
    BEGIN
      DECLARE @tmpID bigint
...
exec('
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raumstunden_Aufsichten ON Gost_Klausuren_Raumstunden_Aufsichten INSTEAD OF INSERT AS
BEGIN
  DECLARE @tmpID bigint
  DECLARE @maxInsertedID bigint

  SET @maxInsertedID = (SELECT max(ID) FROM inserted WHERE ID >= 0)
  INSERT INTO Gost_Klausuren_Raumstunden_Aufsichten
    SELECT * FROM inserted WHERE ID >= 0
    
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Raumstunden_Aufsichten'')
  IF (@tmpID IS NULL)
    BEGIN
      SET @tmpID = (SELECT max(ID) FROM Gost_Klausuren_Raumstunden_Aufsichten)
      IF (@tmpID IS NULL)
        BEGIN
          SET @tmpID = 0
        END
      SET NOCOUNT ON
      INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES (''Gost_Klausuren_Raumstunden_Aufsichten'', @tmpID)
      SET NOCOUNT OFF
    END
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Raumstunden_Aufsichten''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raumstunden_Aufsichten ON Gost_Klausuren_Raumstunden_Aufsichten AFTER UPDATE AS
BEGIN
  if (UPDATE(ID))
    BEGIN
      DECLARE @tmpID bigint
...
BEGIN
  ...
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''Gost_Klausuren_Kalenderinformationen'')
  IF (@tmpID IS NULL)
    BEGIN
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''Gost_Klausuren_Kalenderinformationen''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_INSERT_EigeneSchule_Email ON EigeneSchule_Email INSTEAD OF INSERT AS
BEGIN
  DECLARE @tmpID bigint
  DECLARE @maxInsertedID bigint

  SET @maxInsertedID = (SELECT max(ID) FROM inserted WHERE ID >= 0)
  INSERT INTO EigeneSchule_Email
    SELECT * FROM inserted WHERE ID >= 0
    
  SET @tmpID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle = ''EigeneSchule_Email'')
  IF (@tmpID IS NULL)
    BEGIN
      SET @tmpID = (SELECT max(ID) FROM EigeneSchule_Email)
      IF (@tmpID IS NULL)
        BEGIN
          SET @tmpID = 0
        END
      SET NOCOUNT ON
      INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES (''EigeneSchule_Email'', @tmpID)
      SET NOCOUNT OFF
    END
  ...
  IF (@maxInsertedID > @tmpID)
    BEGIN
      SET @tmpID = @maxInsertedID
	 END
  UPDATE Schema_AutoInkremente SET MaxID = @tmpID WHERE NameTabelle = ''EigeneSchule_Email''
  SET NOCOUNT OFF
END;
')
...
exec('
CREATE TRIGGER t_AutoIncrement_UPDATE_EigeneSchule_Email ON EigeneSchule_Email AFTER UPDATE AS
BEGIN
  if (UPDATE(ID))
    BEGIN
      DECLARE @tmpID bigint
