...
CREATE TABLE Katalog_Aufsichtsbereich (
  ID bigint DEFAULT -1 NOT NULL, 
  Kuerzel nvarchar(20) COLLATE Latin1_General_100_BIN2_UTF8 NOT NULL, 
  Beschreibung nvarchar(1000) COLLATE Latin1_General_100_BIN2_UTF8 NOT NULL,
...
CREATE TABLE LuPO_Faecher (
  ...
  Unterichtssprache nvarchar(1) COLLATE Latin1_General_100_BIN2_UTF8 DEFAULT 'D' NOT NULL, 
  ...
  E1_WStd int, 
  E2_WStd int, 
  E1_S_M nvarchar(1) COLLATE Latin1_General_100_BIN2_UTF8, 
  E2_S_M nvarchar(1) COLLATE Latin1_General_100_BIN2_UTF8, 
  Q_WStd int, 
  E_ExportKursart nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
...
CREATE TABLE LuPO_Jahrgangsdaten (
  Abi_Jahrgang int NOT NULL, 
  ZK_Beginn_GE nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8 DEFAULT 'Q3', 
  ZK_Beginn_SW nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8 DEFAULT 'Q3', 
  BeratungsText nvarchar(2000) COLLATE Latin1_General_100_BIN2_UTF8, 
  MailText nvarchar(2000) COLLATE Latin1_General_100_BIN2_UTF8,
...
CREATE TABLE LuPO_NichtMoeglAbiFachKombi (
  Abi_Jahrgang int NOT NULL, 
  ID nvarchar(30) COLLATE Latin1_General_100_BIN2_UTF8 NOT NULL, 
  ...
  Phase nvarchar(10) COLLATE Latin1_General_100_BIN2_UTF8 DEFAULT '-' NOT NULL, 
  Typ nvarchar(1) COLLATE Latin1_General_100_BIN2_UTF8 DEFAULT '-' NOT NULL,
...
CREATE TABLE LuPO_Schueler (
  ...
  Kommentar nvarchar(max) COLLATE Latin1_General_100_BIN2_UTF8, 
  PruefOrdnung nvarchar(20) COLLATE Latin1_General_100_BIN2_UTF8, 
  Email nvarchar(100) COLLATE Latin1_General_100_BIN2_UTF8, 
  Beratungslehrer nvarchar(50) COLLATE Latin1_General_100_BIN2_UTF8, 
  AnzK_E1 int, 
  AnzK_E2 int, 
  AnzK_Q1 int, 
  AnzK_Q2 int, 
  ...
  AnzS_Q3 int, 
  AnzS_Q4 int, 
  AnzS_Summe nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  AnzK_Summe nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  PruefPhase nvarchar(1) COLLATE Latin1_General_100_BIN2_UTF8, 
  Zeitstempel datetime2, 
  Gliederung nvarchar(3) COLLATE Latin1_General_100_BIN2_UTF8, 
  Konfession nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8, 
  Zulassung nvarchar(1) COLLATE Latin1_General_100_BIN2_UTF8, 
  BLL_Art nvarchar(1) COLLATE Latin1_General_100_BIN2_UTF8, 
  BLL_Punkte int, 
...
CREATE TABLE LuPO_SchuelerFaecher (
  ...
  Schueler_ID bigint NOT NULL, 
  Fach_ID bigint NOT NULL, 
  Kursart_E1 nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  Punkte_E1 nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8, 
  Konflikt_E1 int DEFAULT 0 NOT NULL, 
  Kursart_E2 nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  Punkte_E2 nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8, 
  Konflikt_E2 int DEFAULT 0 NOT NULL, 
  Kursart_Q1 nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  Punkte_Q1 nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8, 
  Konflikt_Q1 int DEFAULT 0 NOT NULL, 
  Kursart_Q2 nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  Punkte_Q2 nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8, 
  Konflikt_Q2 int DEFAULT 0 NOT NULL, 
  Kursart_Q3 nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  Punkte_Q3 nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8, 
  Konflikt_Q3 int DEFAULT 0 NOT NULL, 
  Kursart_Q4 nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  Punkte_Q4 nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8, 
  Konflikt_Q4 int DEFAULT 0 NOT NULL, 
  AbiturFach int, 
  Konflikt_AF int DEFAULT 0 NOT NULL, 
  Bemerkungen nvarchar(50) COLLATE Latin1_General_100_BIN2_UTF8, 
  Fachgruppe nvarchar(5) COLLATE Latin1_General_100_BIN2_UTF8, 
  ...
  MdlPflichtPruefung nvarchar(1) COLLATE Latin1_General_100_BIN2_UTF8,
...
CREATE TABLE LuPO_SchuelerFehlermeldungen (
  ID bigint NOT NULL, 
  Schueler_ID bigint NOT NULL, 
  Fehlercode nvarchar(20) COLLATE Latin1_General_100_BIN2_UTF8, 
  Fehlertext nvarchar(800) COLLATE Latin1_General_100_BIN2_UTF8, 
  Fehlergruppe nvarchar(2) COLLATE Latin1_General_100_BIN2_UTF8, 
  Sortierung int,
...
CREATE TABLE Stundenplan (
  ...
  Beginn datetime2 DEFAULT '1899-01-01' NOT NULL, 
  Ende datetime2, 
  Beschreibung nvarchar(1000) COLLATE Latin1_General_100_BIN2_UTF8 NOT NULL,
