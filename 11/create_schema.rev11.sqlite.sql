...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_1 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden')
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_2 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden SET ID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') + 1 WHERE ID = NEW.ID;
  UPDATE Schema_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden';
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_3 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_4 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden',  NEW.ID);
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_5 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL
BEGIN
  ...
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0) + 1);
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_1 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden')
BEGIN
  UPDATE Schema_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_2 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden SET ID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') + 1 WHERE ID = NEW.ID;
  UPDATE Schema_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_3 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_5 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_1 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten')
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_2 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden_Aufsichten SET ID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') + 1 WHERE ID = NEW.ID;
  UPDATE Schema_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden_Aufsichten';
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_3 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_4 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten',  NEW.ID);
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_5 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL
BEGIN
  ...
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0) + 1);
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_1 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten')
BEGIN
  UPDATE Schema_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden_Aufsichten';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_2 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden_Aufsichten SET ID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') + 1 WHERE ID = NEW.ID;
  UPDATE Schema_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden_Aufsichten';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_3 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_5 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL
BEGIN
...
INSERT INTO Schema_Revision(Revision) VALUES (11);
