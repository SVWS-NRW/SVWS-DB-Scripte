...
DROP TABLE IF EXISTS SchildKursSchueler;
...
DROP TABLE IF EXISTS Statkue_LehrerZugangKat;
DROP TABLE IF EXISTS Statkue_LehrerRechtsverhaeltnisKat;
DROP TABLE IF EXISTS Statkue_LehrerMinderleistungKat;
DROP TABLE IF EXISTS Statkue_LehrerMehrleistungKat;
DROP TABLE IF EXISTS Statkue_LehrerLeitungKat;
DROP TABLE IF EXISTS Statkue_LehrerLehrbefaehigungKat;
DROP TABLE IF EXISTS Statkue_LehrerLehrbefAnerkennungKat;
DROP TABLE IF EXISTS Statkue_LehrerLehramtKat;
DROP TABLE IF EXISTS Statkue_LehrerLehramtAnerkennungKat;
DROP TABLE IF EXISTS Statkue_LehrerFachrichtungKat;
DROP TABLE IF EXISTS Statkue_LehrerFachrAnerkennungKat;
DROP TABLE IF EXISTS Statkue_LehrerEinsatzstatusKat;
DROP TABLE IF EXISTS Statkue_LehrerBeschaeftigungsartKat;
DROP TABLE IF EXISTS Statkue_LehrerAnrechnungKat;
DROP TABLE IF EXISTS Statkue_LehrerAbgangKat;
