...
CREATE TABLE Gost_Blockung (
  ...
  IstAktiv int DEFAULT 0 NOT NULL COMMENT 'Gibt an, ob die Blockung aktiviert wurde oder nicht: 1 - true, 0 - false.Bei einer aktivierten Blockung wurde die Vorlage (siehe Vorlage_ID) bereits in die Leistungsdaten übertragen.',
...
CREATE TABLE Gost_Klausuren_Raeume (
  ...
  Termin_ID bigint COMMENT 'ID des Termins', 
  Katalog_Raum_ID bigint COMMENT 'ID des Raums aus der Tabelle Katalog_Raeume', 
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben';
  IF tmpID IS NULL THEN
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine';
  IF tmpID IS NULL THEN
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren';
  IF tmpID IS NULL THEN
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren';
  IF tmpID IS NULL THEN
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume';
  IF tmpID IS NULL THEN
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden';
  IF tmpID IS NULL THEN
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten';
  IF tmpID IS NULL THEN
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen';
  IF tmpID IS NULL THEN
