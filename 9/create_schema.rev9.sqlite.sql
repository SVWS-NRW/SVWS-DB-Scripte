...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Vorgaben_1 AFTER INSERT ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Vorgaben';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Vorgaben_2 AFTER INSERT ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Vorgaben SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Vorgaben';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Vorgaben_3 AFTER INSERT ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Vorgaben), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Vorgaben', coalesce((SELECT max(ID) FROM Gost_Klausuren_Vorgaben), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Vorgaben_4 AFTER INSERT ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Vorgaben), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Vorgaben',  NEW.ID);
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Vorgaben_5 AFTER INSERT ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') IS NULL
BEGIN
  UPDATE Gost_Klausuren_Vorgaben SET ID = coalesce((SELECT max(ID) FROM Gost_Klausuren_Vorgaben), 0) + 1 WHERE ID = NEW.ID;
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Vorgaben',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Vorgaben), 0) + 1);
END;


CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Vorgaben_1 AFTER UPDATE ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Vorgaben';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Vorgaben_2 AFTER UPDATE ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Vorgaben SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Vorgaben';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Vorgaben_3 AFTER UPDATE ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Vorgaben), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Vorgaben', coalesce((SELECT max(ID) FROM Gost_Klausuren_Vorgaben), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Vorgaben_5 AFTER UPDATE ON Gost_Klausuren_Vorgaben FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Vorgaben') IS NULL
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Termine_1 AFTER INSERT ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Termine';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Termine_2 AFTER INSERT ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Termine SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Termine';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Termine_3 AFTER INSERT ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Termine), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Termine', coalesce((SELECT max(ID) FROM Gost_Klausuren_Termine), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Termine_4 AFTER INSERT ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Termine), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Termine',  NEW.ID);
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Termine_5 AFTER INSERT ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') IS NULL
BEGIN
  UPDATE Gost_Klausuren_Termine SET ID = coalesce((SELECT max(ID) FROM Gost_Klausuren_Termine), 0) + 1 WHERE ID = NEW.ID;
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Termine',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Termine), 0) + 1);
END;


CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Termine_1 AFTER UPDATE ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Termine';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Termine_2 AFTER UPDATE ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Termine SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Termine';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Termine_3 AFTER UPDATE ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Termine), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Termine', coalesce((SELECT max(ID) FROM Gost_Klausuren_Termine), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Termine_5 AFTER UPDATE ON Gost_Klausuren_Termine FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Termine') IS NULL
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kursklausuren_1 AFTER INSERT ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Kursklausuren';
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kursklausuren_2 AFTER INSERT ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Kursklausuren SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Kursklausuren';
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kursklausuren_3 AFTER INSERT ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Kursklausuren), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Kursklausuren', coalesce((SELECT max(ID) FROM Gost_Klausuren_Kursklausuren), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kursklausuren_4 AFTER INSERT ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Kursklausuren), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Kursklausuren',  NEW.ID);
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kursklausuren_5 AFTER INSERT ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') IS NULL
BEGIN
  UPDATE Gost_Klausuren_Kursklausuren SET ID = coalesce((SELECT max(ID) FROM Gost_Klausuren_Kursklausuren), 0) + 1 WHERE ID = NEW.ID;
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Kursklausuren',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Kursklausuren), 0) + 1);
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Kursklausuren_1 AFTER UPDATE ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Kursklausuren';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Kursklausuren_2 AFTER UPDATE ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Kursklausuren SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Kursklausuren';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Kursklausuren_3 AFTER UPDATE ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Kursklausuren), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Kursklausuren', coalesce((SELECT max(ID) FROM Gost_Klausuren_Kursklausuren), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Kursklausuren_5 AFTER UPDATE ON Gost_Klausuren_Kursklausuren FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kursklausuren') IS NULL
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Schuelerklausuren_1 AFTER INSERT ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Schuelerklausuren';
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Schuelerklausuren_2 AFTER INSERT ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Schuelerklausuren SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Schuelerklausuren';
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Schuelerklausuren_3 AFTER INSERT ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Schuelerklausuren), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Schuelerklausuren', coalesce((SELECT max(ID) FROM Gost_Klausuren_Schuelerklausuren), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Schuelerklausuren_4 AFTER INSERT ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Schuelerklausuren), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Schuelerklausuren',  NEW.ID);
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Schuelerklausuren_5 AFTER INSERT ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') IS NULL
BEGIN
  ...
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Schuelerklausuren',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Schuelerklausuren), 0) + 1);
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Schuelerklausuren_1 AFTER UPDATE ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Schuelerklausuren';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Schuelerklausuren_2 AFTER UPDATE ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Schuelerklausuren SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Schuelerklausuren';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Schuelerklausuren_3 AFTER UPDATE ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Schuelerklausuren), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Schuelerklausuren', coalesce((SELECT max(ID) FROM Gost_Klausuren_Schuelerklausuren), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Schuelerklausuren_5 AFTER UPDATE ON Gost_Klausuren_Schuelerklausuren FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Schuelerklausuren') IS NULL
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_1 AFTER INSERT ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Raeume';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_2 AFTER INSERT ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_3 AFTER INSERT ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_4 AFTER INSERT ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume',  NEW.ID);
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_5 AFTER INSERT ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') IS NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume SET ID = coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume), 0) + 1 WHERE ID = NEW.ID;
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume), 0) + 1);
END;


CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_1 AFTER UPDATE ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Raeume';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_2 AFTER UPDATE ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_3 AFTER UPDATE ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_5 AFTER UPDATE ON Gost_Klausuren_Raeume FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume') IS NULL
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_1 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_2 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_3 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0));
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_4 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL AND
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden',  NEW.ID);
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_5 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden SET ID = coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0) + 1 WHERE ID = NEW.ID;
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0) + 1);
END;


CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_1 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_2 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_3 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_4 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL AND
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0)
BEGIN
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_5 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden') IS NULL
BEGIN
  -- Update der ID in der Tabelle Gost_Klausuren_Raeume_Stunden erfolgt durch den Autoinkrement-Trigger 2, daher hier auch kein +1, sondern nur den Max-Wert schreiben
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden), 0));
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_1 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden_Aufsichten';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_2 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden_Aufsichten SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden_Aufsichten';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_3 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0));
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_4 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL AND
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten',  NEW.ID);
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Raeume_Stunden_Aufsichten_5 AFTER INSERT ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden_Aufsichten SET ID = coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0) + 1 WHERE ID = NEW.ID;
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0) + 1);
END;


CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_1 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden_Aufsichten';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_2 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Raeume_Stunden_Aufsichten SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Raeume_Stunden_Aufsichten';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_3 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten', coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_4 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL AND
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0)
BEGIN
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Raeume_Stunden_Aufsichten_5 AFTER UPDATE ON Gost_Klausuren_Raeume_Stunden_Aufsichten FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Raeume_Stunden_Aufsichten') IS NULL
BEGIN
  -- Update der ID in der Tabelle Gost_Klausuren_Raeume_Stunden_Aufsichten erfolgt durch den Autoinkrement-Trigger 2, daher hier auch kein +1, sondern nur den Max-Wert schreiben
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Raeume_Stunden_Aufsichten',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Raeume_Stunden_Aufsichten), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kalenderinformationen_1 AFTER INSERT ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Kalenderinformationen';
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kalenderinformationen_2 AFTER INSERT ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Kalenderinformationen SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Kalenderinformationen';
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kalenderinformationen_3 AFTER INSERT ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Kalenderinformationen), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Kalenderinformationen', coalesce((SELECT max(ID) FROM Gost_Klausuren_Kalenderinformationen), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kalenderinformationen_4 AFTER INSERT ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Gost_Klausuren_Kalenderinformationen), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Kalenderinformationen',  NEW.ID);
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Gost_Klausuren_Kalenderinformationen_5 AFTER INSERT ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') IS NULL
BEGIN
  ...
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Kalenderinformationen',  coalesce((SELECT max(ID) FROM Gost_Klausuren_Kalenderinformationen), 0) + 1);
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Kalenderinformationen_1 AFTER UPDATE ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen')
BEGIN
  UPDATE SVWS_DB_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Gost_Klausuren_Kalenderinformationen';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Kalenderinformationen_2 AFTER UPDATE ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') IS NOT NULL
BEGIN
  UPDATE Gost_Klausuren_Kalenderinformationen SET ID = (SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') + 1 WHERE ID = NEW.ID;
  UPDATE SVWS_DB_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Gost_Klausuren_Kalenderinformationen';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Kalenderinformationen_3 AFTER UPDATE ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Gost_Klausuren_Kalenderinformationen), 0)
BEGIN
  INSERT INTO SVWS_DB_AutoInkremente(NameTabelle, MaxID) VALUES ('Gost_Klausuren_Kalenderinformationen', coalesce((SELECT max(ID) FROM Gost_Klausuren_Kalenderinformationen), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Gost_Klausuren_Kalenderinformationen_5 AFTER UPDATE ON Gost_Klausuren_Kalenderinformationen FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Gost_Klausuren_Kalenderinformationen') IS NULL
BEGIN
