...
DROP TABLE IF EXISTS Verkehrssprachen;
...
DROP TABLE IF EXISTS Statkue_SVWS_SprachpruefungNiveaus;
...
DROP TABLE IF EXISTS Schulgliederungen_Schulformen;
DROP TABLE IF EXISTS Schulgliederungen_Abschluesse_Berufsbildend;
DROP TABLE IF EXISTS Schulgliederungen_Abschluesse_Allgemeinbildend;
DROP TABLE IF EXISTS Schulgliederungen;
DROP TABLE IF EXISTS Schulformen;
DROP TABLE IF EXISTS SchuleCredentials;
DROP TABLE IF EXISTS Schulabschluesse_Berufsbildend;
DROP TABLE IF EXISTS Schulabschluesse_Allgemeinbildend;
DROP TABLE IF EXISTS SchuelerStatus;
DROP TABLE IF EXISTS SchuelerListe;
DROP TABLE IF EXISTS Schildintern_UnicodeUmwandlung;
...
DROP TABLE IF EXISTS Schildintern_FilterFehlendeEintraegeSchild3;
...
DROP TABLE IF EXISTS Religionen;
...
DROP TABLE IF EXISTS KlassenartenKatalog_Schulformen;
DROP TABLE IF EXISTS KlassenartenKatalog_Keys;
DROP TABLE IF EXISTS KlassenartenKatalog;
...
DROP TABLE IF EXISTS Jahrgaenge_Bezeichnungen;
...
DROP TABLE IF EXISTS Foerderschwerpunkte_Schulformen;
DROP TABLE IF EXISTS Foerderschwerpunkte;
...
DROP TABLE IF EXISTS EinschulungsartKatalog;
...
DROP TABLE IF EXISTS Berufskolleg_Fachklassen;
...
DROP TABLE IF EXISTS AllgemeineMerkmaleKatalog_Schulformen;
DROP TABLE IF EXISTS AllgemeineMerkmaleKatalog_Keys;
DROP TABLE IF EXISTS AllgemeineMerkmaleKatalog;
