DROP TABLE IF EXISTS EigeneSchule_Email;
DROP TABLE IF EXISTS Gost_Klausuren_Kalenderinformationen;
DROP TABLE IF EXISTS Gost_Klausuren_Raumstunden_Aufsichten;
DROP TABLE IF EXISTS Gost_Klausuren_SchuelerklausurenTermine_Raumstunden;
DROP TABLE IF EXISTS Gost_Klausuren_Raumstunden;
DROP TABLE IF EXISTS Gost_Klausuren_Raeume;
DROP TABLE IF EXISTS Gost_Klausuren_NtaZeiten;
DROP TABLE IF EXISTS Gost_Klausuren_Schuelerklausuren_Termine;
DROP TABLE IF EXISTS Gost_Klausuren_Schuelerklausuren;
DROP TABLE IF EXISTS Gost_Klausuren_Kursklausuren;
DROP TABLE IF EXISTS Gost_Klausuren_Termine_Jahrgaenge;
DROP TABLE IF EXISTS Gost_Klausuren_Termine;
DROP TABLE IF EXISTS Gost_Klausuren_Vorgaben;
DROP TABLE IF EXISTS Schulbewerbung_Importe;
DROP TABLE IF EXISTS EnmTeilleistungen;
...
DROP TABLE IF EXISTS LehrerNotenmodulCredentials;
