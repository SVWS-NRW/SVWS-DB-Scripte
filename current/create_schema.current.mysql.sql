...
CREATE TABLE Katalog_Pausenzeiten (
  ID bigint DEFAULT -1 NOT NULL, 
  Tag int NOT NULL, 
  Beginn time DEFAULT (CURRENT_TIME) NOT NULL, 
  Ende time DEFAULT (CURRENT_TIME) NOT NULL,
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='EigeneSchule_KAoADaten' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM EigeneSchule_KAoADaten INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Katalog_Aufsichtsbereich' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Katalog_Aufsichtsbereich INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Katalog_Pausenzeiten' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Katalog_Pausenzeiten INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Katalog_Raeume' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Katalog_Raeume INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Katalog_Zeitraster' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Katalog_Zeitraster INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Schuljahresabschnitte' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Schuljahresabschnitte INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
delimiter $
CREATE TRIGGER t_AutoIncrement_INSERT_SchulleitungFunktion
BEFORE INSERT
  ON SchulleitungFunktion FOR EACH ROW
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='SchulleitungFunktion' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM SchulleitungFunktion INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
delimiter $
CREATE TRIGGER t_AutoIncrement_UPDATE_SchulleitungFunktion
BEFORE UPDATE
  ON SchulleitungFunktion FOR EACH ROW
BEGIN
  DECLARE tmpID bigint;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='LehrerAbschnittsdaten' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM LehrerAbschnittsdaten INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Schulleitung' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Schulleitung INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='LehrerAnrechnung' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM LehrerAnrechnung INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='LehrerEntlastung' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM LehrerEntlastung INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='LehrerFunktionen' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM LehrerFunktionen INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='LehrerMehrleistung' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM LehrerMehrleistung INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Klassen' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Klassen INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='SchuelerSprachpruefungen' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM SchuelerSprachpruefungen INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='SchuelerZP10' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM SchuelerZP10 INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_Aufsichtsbereiche' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_Aufsichtsbereiche INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_Pausenzeit' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_Pausenzeit INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_Pausenaufsichten' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_Pausenaufsichten INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_PausenaufsichtenBereich' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_PausenaufsichtenBereich INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_Raeume' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_Raeume INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_Zeitraster' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_Zeitraster INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_Unterricht' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_Unterricht INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_UnterrichtLehrer' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_UnterrichtLehrer INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID FROM SVWS_DB_AutoInkremente WHERE NameTabelle='Stundenplan_UnterrichtRaum' INTO tmpID;
  IF tmpID IS NULL THEN
    SELECT max(ID) FROM Stundenplan_UnterrichtRaum INTO tmpID;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
...
INSERT INTO SVWS_DB_Version(Revision) VALUES (5);
