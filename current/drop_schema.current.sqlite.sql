...
DROP TABLE IF EXISTS Statkue_SVWS_ZulaessigeKursarten;
DROP TABLE IF EXISTS Statkue_SVWS_ZulaessigeJahrgaenge;
DROP TABLE IF EXISTS Statkue_SVWS_ZulaessigeFaecher;
...
DROP TABLE IF EXISTS Statkue_SVWS_Schulgliederungen;
DROP TABLE IF EXISTS Statkue_SVWS_BKAnlagen;
...
DROP TABLE IF EXISTS SchulleitungFunktion;
