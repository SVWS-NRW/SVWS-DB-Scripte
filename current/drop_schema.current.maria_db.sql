...
DROP TABLE IF EXISTS Statkue_SVWS_Fachgruppen;
...
DROP TABLE IF EXISTS LuPO_SchuelerFaecher;
DROP TABLE IF EXISTS LuPO_Schueler;
DROP TABLE IF EXISTS LuPO_NichtMoeglAbiFachKombi;
DROP TABLE IF EXISTS LuPO_Jahrgangsdaten;
DROP TABLE IF EXISTS LuPO_Faecher;
DROP TABLE IF EXISTS LuPO_Beratungslehrer;
