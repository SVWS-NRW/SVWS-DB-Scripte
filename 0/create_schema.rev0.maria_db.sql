...
CREATE TABLE EigeneSchule_KAoADaten (
  ...
  SchulnrEigner int NOT NULL COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden',
...
CREATE TABLE EigeneSchule_Teilstandorte (
  ...
  Strasse varchar(55) COMMENT 'Straße des Teilstandortes', 
...
CREATE TABLE EigeneSchule_Faecher (
  ...
  Fachgruppe_ID bigint COMMENT 'DEPRECATED: Feld zum Festlegen der ID für die Zeugnisdatenquelle in Schild, wird während der Migration umbenannt.', 
...
CREATE TABLE K_Datenschutz (
  ...
  Bezeichnung varchar(250) NOT NULL COMMENT 'Eine kurze Bezeichnung des DSGVO-Merkmals', 
  Sichtbar varchar(1) DEFAULT '+' NOT NULL COMMENT 'Regelt die Sichtbarkeit des Merkmals bei der Ansicht der Schülertabelle ', 
  Schluessel varchar(20) COMMENT 'Fest vorgegebene Werte, die es in Schild-NRW später ermöglichen, die DSGVO-Merkmale zu erkennen', 
  SchulnrEigner int NOT NULL COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  Sortierung int DEFAULT 32000 NOT NULL COMMENT 'Gibt die Reihenfolge der Merkmale bei der Darstellung an.', 
  Beschreibung longtext COMMENT 'Eine ausführliche Beschreibung des DSGCO-Merkmals', 
  PersonArt varchar(1) COMMENT 'PersonenArt des Datenschutz-Eintrags (S=Schueler L=Lehrer)',
  CONSTRAINT PK_K_Datenschutz PRIMARY KEY (ID)
) COMMENT 'Tabelle für die DSGVO Einwilligungsarten';
...
CREATE TABLE K_ErzieherFunktion (
  ...
  SchulnrEigner int COMMENT 'DEPRECATED: Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden',
...
CREATE TABLE K_Kindergarten (
  ...
  Strasse varchar(55) COMMENT 'Straße des Kindergartens', 
...
CREATE TABLE K_Ortsteil (
  ...
  PLZ varchar(10) COMMENT 'PLZ des Ortsteils', 
...
CREATE TABLE K_AllgAdresse (
  ...
  AllgAdrAdressArt varchar(30) COMMENT 'DEPRECATED Die Bezeichnung der Adressart des Betriebs', 
  AllgAdrName1 varchar(50) COMMENT 'Name1 des Betriebs', 
  AllgAdrName2 varchar(50) COMMENT 'Name2 des Betriebs', 
  AllgAdrStrasse varchar(55) COMMENT 'Straße des Betriebs', 
  ...
  AllgAdrPLZ varchar(10) COMMENT 'DEPRECATED: PLZ des Betriebs', 
...
CREATE TABLE K_Schule (
  ...
  Strasse varchar(55) COMMENT 'Straße des Eintrags der Schulen', 
...
CREATE TABLE K_Lehrer (
  ...
  Strasse varchar(55) COMMENT 'Adressdaten des Lehrers: Strasse', 
  ...
  PLZ varchar(10) COMMENT 'DEPRECATED: Adressdaten des Lehrers: Postleitzahl - Ort als Spalte in der Tabelle ergänzen, ähnlich wie bei Schüler, wichtig da ansonsten Probleme auftauchen, wenn ein PLZ ? Ortsname nicht eindeutig ist, was gelegentlich vorkommt', 
  ...
  EntlastungStd float COMMENT 'Berechnetes Feld: Die Stunden für eine Entlastung', 
  AnrechnungStd float COMMENT 'Berechnetes Feld: Die angerechneten Stunden für eine nichtunterrichtliche Tätigkeit', 
  RestStd float COMMENT 'Berechnetes Feld: Reststunden', 
  LPassword varchar(255) COMMENT 'Wird für das GS-Modul genutzt (gehashed).', 
  PWAktuell varchar(3) DEFAULT '-;5' COMMENT 'Gibt an ob das LPassword geändert wurde oder ob es noch das Initialkennwort ist', 
  SchILDweb_FL varchar(1) DEFAULT '+' COMMENT 'DEPRECATED: nicht mehr genutzt SchildWeb', 
  SchILDweb_KL varchar(1) DEFAULT '+' COMMENT 'DEPRECATED: nicht mehr genutzt SchildWeb', 
  SchILDweb_Config longtext COMMENT 'DEPRECATED: nicht mehr genutzt SchildWeb', 
  KennwortTools varchar(255) COMMENT 'DEPRECATED: wurde nie verwendet', 
  Antwort1 varchar(255) COMMENT 'DEPRECATED: wurde nie verwendet', 
  Antwort2 varchar(255) COMMENT 'DEPRECATED: wurde nie verwendet', 
  KennwortToolsAktuell varchar(3) DEFAULT '-;5' COMMENT 'DEPRECATED: wurde nie verwendet', 
  XNMPassword varchar(255) COMMENT 'Passwort für das XNM-Tool ', 
  XNMPassword2 varchar(255) COMMENT 'zweites Passwort für das XNM-Tool ', 
  CredentialID bigint COMMENT 'Die ID des Credential-Eintrags',
...
CREATE TABLE LehrerFotos (
  ...
  Foto longblob COMMENT 'Lehrerfoto im binär-Format', 
...
CREATE TABLE Personengruppen_Personen (
  ...
  PersonStrasse varchar(55) COMMENT 'Straße des Personeneintrags zur Personengruppe', 
...
CREATE TABLE EigeneSchule (
  ...
  Strasse varchar(55) COMMENT 'Straße der eigenen Schule', 
  Strassenname varchar(55) COMMENT 'Straßenname der Schule', 
  HausNr varchar(10) COMMENT 'Hausnummer wenn getrennt gespeichert', 
  HausNrZusatz varchar(30) COMMENT 'Hausnummerzusatz wenn getrennt gespeichert', 
  ...
  SchulLogo longblob COMMENT 'Schullogo als Bild im Binärformat', 
  SchulLogoBase64 longtext COMMENT 'Schullogo als Bild im Base64-Format', 
  SchulnrEigner int COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  SchulleiterName varchar(120) COMMENT 'Nachname der Schulleitung', 
  SchulleiterVorname varchar(80) COMMENT 'Vorname der Schulleitung', 
  SchulleiterAmtsbez varchar(30) COMMENT 'Amtsbezeichnung der Schulleitung', 
  SchulleiterGeschlecht int COMMENT 'Geschlecht der Schulleitung', 
  StvSchulleiterName varchar(120) COMMENT 'Name der stellvertretenden Schulleitung', 
  StvSchulleiterVorname varchar(80) COMMENT 'Vorname der stellvertretenden Schulleitung', 
  StvSchulleiterAmtsbez varchar(30) COMMENT 'Amtsbezeichnung der stellvertretenden Schulleitung', 
  StvSchulleiterGeschlecht int COMMENT 'Geschlecht der stellvertretenden Schulleitung', 
  Einstellungen longtext COMMENT 'DEPRECATED: Schild2 - Einstellungen zur Schule im INI-Format (kann in einem Texteditor gelesen werden). Wird in Schild 3 ausgelagert.', 
  ...
  Schuljahr int COMMENT 'Aktuelle Schuljahr der Datenbank', 
  SchuljahrAbschnitt int COMMENT 'Aktueller Abschnitt der Datenbank',
...
CREATE TABLE EigeneSchule_Abteilungen (
  ...
  AbteilungsLeiter varchar(10) COMMENT 'DEPRECATED: Lehrer-Kürzel für den Abteilungsleiter', 
  SchulnrEigner int COMMENT 'DEPRECATED: Schulnummer zu der der Datensatz gehört',
...
CREATE TABLE LehrerAbschnittsdaten (
  ...
  SchulnrEigner int COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  Jahr int NOT NULL COMMENT 'Schuljahr für die LehrerAbschnittsdaten', 
  Abschnitt int NOT NULL COMMENT 'Abschnit für die LehrerAbschnittsdaten',
...
CREATE TABLE Kurse (
  ...
  LehrerKrz varchar(22) COMMENT 'DEPRECATED: Lehrerkürzel des unterrichtenden Lehrers des Kurses', 
  ...
  Jahr int NOT NULL COMMENT 'Schuljahr des Kurses', 
  Abschnitt int NOT NULL COMMENT 'Abschnitt des Kurses',
...
CREATE TABLE LehrerAnrechnung (
  ...
  Lehrer_ID bigint NOT NULL COMMENT 'DEPRECATED: Lehrer-ID für die Anrechnungsstunden, in LehrerAbchnittsdaten enthalten', 
  ...
  Jahr int COMMENT 'Schuljahr für die Anrechnungsstunden', 
  Abschnitt int COMMENT 'Abschnit für die Anrechnungsstunden', 
  SchulnrEigner int COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden',
...
CREATE TABLE LehrerEntlastung (
  ...
  Lehrer_ID bigint NOT NULL COMMENT 'DEPRECATED: Lehrer-ID für die Entlastungsstunden (Mehr-Minderleistung), in LehrerAbchnittsdaten enthalten', 
  Abschnitt_ID bigint NOT NULL COMMENT 'ID der Lehrerabschnittsdaten', 
  ...
  Jahr int COMMENT 'Schuljahr für die Entlastungsstunden (Minderleistung)', 
  Abschnitt int COMMENT 'Abschnitt für die Entlastungsstunden (Minderleistung)', 
  SchulnrEigner int COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden',
...
CREATE TABLE LehrerFunktionen (
  ...
  Lehrer_ID bigint NOT NULL COMMENT 'DEPRECATED: Lehrer-ID zu der die schulinterne Funktion gehört, in LehrerAbchnittsdaten enthalten', 
  Abschnitt_ID bigint NOT NULL COMMENT 'ID der Lehrerabschnittsdaten', 
  Funktion_ID bigint NOT NULL COMMENT 'ID der schulinternen Funktion', 
  Jahr int NOT NULL COMMENT 'Schuljahr zu dem die schulinterne Funktion gehört', 
  Abschnitt int NOT NULL COMMENT 'Abschnitt zu dem die schulinterne Funktion gehört', 
  SchulnrEigner int COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden',
...
CREATE TABLE LehrerMehrleistung (
  ...
  Lehrer_ID bigint NOT NULL COMMENT 'DEPRECATED: Lehrer-ID die zu den Mehrarbeitsstunden gehört, in LehrerAbchnittsdaten enthalten', 
  Abschnitt_ID bigint NOT NULL COMMENT 'ID der Lehrerabschnittsdaten', 
  ...
  Jahr int NOT NULL COMMENT 'Schuljahr der Mehrarbeitsstunden', 
  Abschnitt int NOT NULL COMMENT 'Abschnitt der Mehrarbeitsstunden', 
  SchulnrEigner int COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden',
...
CREATE TABLE Schueler (
  ...
  Strasse varchar(55) COMMENT 'Straße des Schülers', 
  Strassenname varchar(55) COMMENT 'Straßenname des Schülers', 
  HausNr varchar(10) COMMENT 'Hausnummer wenn getrennt gespeichert', 
  HausNrZusatz varchar(30) COMMENT 'Zusatz zur Hausnummer wenn Hausnummern getrennt gespeichert werden', 
  Ort_ID bigint COMMENT 'ID des Orts des Schülers', 
  PLZ varchar(10) COMMENT 'DEPRECATED: PLZ des Schülers', 
  OrtAbk varchar(50) COMMENT 'DEPRECATED: Klartext des Orts des Schülers', 
  ...
  Klassen_ID bigint COMMENT 'DEPRECATED: ID der Klasse des Schülers - verschoben nach SchuelerLernabschittsdaten', 
  Jahrgang smallint COMMENT 'DEPRECATED: Schulbesuchsjahre - verschoben nach SchuelerLernabschittsdaten.Schulbesuchsjahre', 
  PruefOrdnung varchar(20) COMMENT 'DEPRECATED: Prüfungsordnung des Schülers - verschoben nach SchuelerLernabschittsdaten', 
  ...
  StaatAbk varchar(50) COMMENT 'DEPRECATED: Klartext der 1. Staatsangehörigkeit des Schülers', 
  ...
  ReligionAbk varchar(30) COMMENT 'Klartext des Religionseintrags', 
  ...
  Schwerbehinderung varchar(1) DEFAULT '-' COMMENT 'DEPRECATED: Gibt an ob eine Schwerbehinderung vorliegt Ja Nein - verschoben nach SchuelerLernabschittsdaten', 
  ...
  HaltestelleAbk varchar(30) COMMENT 'DEPRECATED: Text der Haltestelle', 
  ASDSchulform varchar(3) COMMENT 'DEPRECATED: ASD-Kürzel der Schulgliederung - Spalte fehlerhaft benannt! - verschoben nach SchuelerLernabschittsdaten', 
  Jahrgang_ID bigint COMMENT 'DEPRECATED: ID des Jahrgangs - verschoben nach SchuelerLernabschittsdaten', 
  ASDJahrgang varchar(2) COMMENT 'DEPRECATED: ASD-Kürzel des Jahrgangs - verschoben nach SchuelerLernabschittsdaten', 
  Fachklasse_ID bigint COMMENT 'DEPRECATED: ID der Fachklasse (BK) - verschoben nach SchuelerLernabschittsdaten', 
  ...
  RefPaed varchar(1) DEFAULT '-' COMMENT 'DEPRECATED: Teilnahme an Reformpädagogik - verschoben nach SchuelerLernabschittsdaten', 
  ...
  Bemerkungen longtext COMMENT 'Text für Bemerkungen zum Schüler Memofeld', 
  BeginnBildungsgang date COMMENT 'Beginn des Bildungsgangs BK', 
  OrgFormKrz varchar(1) COMMENT 'DEPRECATED: Kürzel der Organisationsform IT.NRW - verschoben nach SchuelerLernabschnittsdaten', 
  Klassenart varchar(2) COMMENT 'DEPRECATED: Klassenart IT.NRW - verschoben nach SchuelerLernabschittsdaten ', 
  ...
  Schwerpunkt_ID bigint COMMENT 'DEPRECATED: ID des Schwerpunkt (BK und RS) - verschoben nach SchuelerLernabschnittsdaten', 
  ...
  Autist varchar(1) DEFAULT '-' COMMENT 'DEPRECATED: Gibt an ob Autismuss vorliegt (Ja/Nein) - verschoben nach Tabelle SchuelerLernabschnittsdaten', 
  ...
  SchulnrEigner int COMMENT 'DEPRECATED: Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  BilingualerZweig varchar(1) COMMENT 'DEPRECATED: Sprache des Bilingualen Zweigs, verschoben nach Tabelle SchuelerLernabschnittsdaten', 
  ...
  StaatAbk2 varchar(50) COMMENT 'DEPRECATED: Kürzel der 2. Staatsangehörigkeit', 
  ...
  AOSF varchar(1) DEFAULT '-' COMMENT 'DEPRECATED Gibt an ob der Schüler ein AOSF hat - verschoben nach Tabelle SchuelerLernabschnittsdaten ', 
  ...
  ZieldifferentesLernen varchar(1) DEFAULT '-' COMMENT 'DEPRECATED: Gibt an ob der Schüler zieldifferent unterrichtet wird - verschoben nach Tabelle SchuelerLernabschnittsdaten', 
  ...
  CredentialID bigint COMMENT 'Die ID des Credential-Eintrags', 
  AktSchuljahr smallint COMMENT 'DEPRECATED: Aktuelles Schuljahr des Schülers', 
  AktAbschnitt smallint COMMENT 'DEPRECATED: Aktueller Abschnitt des Schülers', 
  Klasse varchar(15) COMMENT 'DEPRECATED: Klartext Klasse des Schülers', 
...
CREATE TABLE EigeneSchule_Abt_Kl (
  ...
  Klasse varchar(15) NOT NULL COMMENT 'DEPRECATED: Klassenbezeichnung die zur Abteilung gehört', 
...
CREATE TABLE SchuelerAbiFaecher (
  ...
  FSortierung int COMMENT 'Eine Zahl, welche die Sortierung der Fächer angibt', 
  ...
  SchulnrEigner int COMMENT 'DEPRECATED: Die Nummer der Schule, zu der dieser Datensatz gehört (falls mehrere Schulen mit dem gleichen Schema arbeiten)', 
  Fachlehrer varchar(10) COMMENT 'DEPRECATED: Letzer Kurs Q2, 2.Hj: Der Fachlehrer, der als letztes in diesem Fach unterrichtet hat',
...
CREATE TABLE SchuelerAbitur (
  ...
  Latinum varchar(1) DEFAULT '-' COMMENT 'Sprachqualifikation: Latinum', 
  KlLatinum varchar(1) DEFAULT '-' COMMENT 'Sprachqualifikation: Kleines Latinum', 
  Graecum varchar(1) DEFAULT '-' COMMENT 'Sprachqualifikation: Graecum', 
  Hebraicum varchar(1) DEFAULT '-' COMMENT 'Sprachqualifikation: Hebraicum', 
  ...
  SummenOK smallint COMMENT 'DEPRECATED: Punktsummen OK für alte APO für alres G9 (1: , NULL: )', 
  ...
  Jahr int COMMENT 'Das Schuljahr der Abiturprüfung', 
  Abschnitt int COMMENT 'Der Schuljahres-Abschnitt der Abiturprüfung', 
  SchulnrEigner int COMMENT 'Die Nummer der Schule, zu der dieser Datensatz gehört (falls mehrere Schulen mit dem gleichen Schema arbeiten)',
...
CREATE TABLE SchuelerBKAbschluss (
  ...
  Jahr int COMMENT 'Schuljahr für den BKAbschlussReiter', 
  Abschnitt int COMMENT 'Abschnitt  für den BKAbschlussReiter',
...
CREATE TABLE SchuelerBKFaecher (
  ...
  Jahr int COMMENT 'Schuljahr des Facheintrags für den BKAbschlussReiter', 
  Abschnitt int COMMENT 'Abschnitt des Facheintrags für den BKAbschlussReiter', 
  Fachlehrer varchar(10) COMMENT 'DEPRECATED: Lehrer  des Facheintrags für den BKAbschlussReiter',
...
CREATE TABLE SchuelerErzAdr (
  ...
  ErzStrasse varchar(55) COMMENT 'Straße zum Erzieherdatensatz', 
  ...
  ErzPLZ varchar(10) COMMENT 'DEPRECATED: PLZ zum Erzieherdatensatz', 
...
CREATE TABLE SchuelerFotos (
  ...
  Foto longblob COMMENT 'Schülerfoto im binär-Format', 
...
CREATE TABLE SchuelerLernabschnittsdaten (
  ...
  Klassenlehrer varchar(10) COMMENT 'Klassenlehrer Kürzel (hier muss ID rein)', 
  ...
  StvKlassenlehrer_ID bigint COMMENT 'Stellvertretender Klassenlehrer Kürzel sollte ID sein', 
  ...
  Jahr int NOT NULL COMMENT 'DEPRECATED: Schuljahr des Lernabschnitts', 
  Abschnitt int NOT NULL COMMENT 'DEPRECATED: Abschnitt des Lernabschnitts', 
  SchulnrEigner int COMMENT 'DEPRECATED: Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  Klasse varchar(15) COMMENT 'DEPRECATED: Klassen-Bezeichnung für den Lernabschnitts', 
  Folgeklasse varchar(15) COMMENT 'DEPRECATED: Bezeichnung der Folgeklasse für den Lernabschnitt des Schülers',
...
CREATE TABLE SchuelerSprachenfolge (
  ...
  SchulnrEigner int COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  Fach_ID bigint COMMENT 'DEPRECATED: FachID des Sprachenfolgeeintrags, Ersetzt durch das Sprachenkürzel', 
  Reihenfolge varchar(1) COMMENT 'DEPRECATED: Reihenfolge Nummer des Sprachenfolgeeintrags bzw. N oder P, ersetzt durch ReihenfolgeNr und Sprachprüfung-Tabelle', 
  JahrgangVon smallint COMMENT 'DEPRECATED: Jahrgang Beginn des Sprachenfolgeeintrags, durch ASDJahrgang ersetzt', 
  JahrgangBis smallint COMMENT 'DEPRECATED: Jahrgang Ende des Sprachenfolgeeintrags, durch ASDJahrgang ersetzt',
...
CREATE TABLE SchuelerAnkreuzfloskeln (
  ...
  Schueler_ID bigint NOT NULL COMMENT 'DEPRECATED: Schüler-ID zum Ankreuzfloskeleintrag, in Abschnitt_ID enthalten', 
  ...
  SchulnrEigner int NOT NULL COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  Jahr int NOT NULL COMMENT 'Schuljahr zum Ankreusfloskeleintrag', 
  Abschnitt int NOT NULL COMMENT 'Abschnitt zum Ankreusfloskeleintrag',
...
CREATE TABLE SchuelerFoerderempfehlungen (
  ...
  Schueler_ID bigint NOT NULL COMMENT 'DEPRECATED: Schüler-ID der Förderempfehlung, in Abschnitt_ID enthalten', 
  ...
  Jahr int COMMENT 'Schuljahr der Förderempfehlung', 
  Abschnitt int COMMENT 'Abschnitt der Förderempfehlung', 
  SchulnrEigner int NOT NULL COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  Klasse varchar(15) COMMENT 'DEPRECATED: Klassen-Bezeichnung der Förderempfehlung',
...
CREATE TABLE SchuelerKAoADaten (
  ...
  Schueler_ID bigint NOT NULL COMMENT 'DEPRECATED: Schüler-ID des KAOA-Eintrags beim Schüler, in Abschnitt_ID enthalten', 
  Abschnitt_ID bigint NOT NULL COMMENT 'ID der zugehörigen Schülerlernabschnittsdaten', 
  ...
  SchulnrEigner int NOT NULL COMMENT 'Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  Jahr int NOT NULL COMMENT 'Schuljahr des KAOA-Eintrags beim Schüler', 
  Abschnitt int NOT NULL COMMENT 'Abschnitt des KAOA-Eintrags beim Schüler',
...
CREATE TABLE SchuelerLeistungsdaten (
  ...
  Fachlehrer varchar(10) COMMENT 'DEPRECATED: Das Kürzel des zugehörigen Fach-Lehrers', 
  Zusatzkraft varchar(10) COMMENT 'DEPRECATED: Das Kürzel der Zusatzkraft / des Lehrers',
...
CREATE TABLE Stundentafel_Faecher (
  ...
  SchulnrEigner int COMMENT 'DEPRECATED: Die Schulnummer zu welcher der Datensatz gehört – wird benötigt, wenn mehrere Schulen in einem Schema der Datenbank gespeichert werden', 
  LehrerKrz varchar(10) COMMENT 'DEPRECATED: LehrerKRZ des Faches in der Stundetafel',
...
delimiter $
CREATE TRIGGER t_INSERT_EIGENESCHULE_ABSCHNITTE BEFORE INSERT ON EigeneSchule FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
...
delimiter $
CREATE TRIGGER t_INSERT_SCHUELER_ABSCHNITTE BEFORE INSERT ON Schueler FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
...
delimiter $
CREATE TRIGGER t_INSERT_SCHUELERLERNABSCHNITTDATEN_ABSCHNITTE BEFORE INSERT ON SchuelerLernabschnittsdaten FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
...
delimiter $
CREATE TRIGGER t_INSERT_SCHUELERABITUR_ABSCHNITTE BEFORE INSERT ON SchuelerAbitur FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_SCHUELERANKREUZFLOSKELN_ABSCHNITTE BEFORE INSERT ON SchuelerAnkreuzfloskeln FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_SCHUELERBKABSCHLUSS_ABSCHNITTE BEFORE INSERT ON SchuelerBKAbschluss FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_SCHUELERBKFAECHER_ABSCHNITTE BEFORE INSERT ON SchuelerBKFaecher FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_SCHUELERFOERDEREMPFEHLUNGEN_ABSCHNITTE BEFORE INSERT ON SchuelerFoerderempfehlungen FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_SCHUELERKAOADATEN_ABSCHNITTE BEFORE INSERT ON SchuelerKAoADaten FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_LEHRERLERNABSCHNITTSDATEN_ABSCHNITTE BEFORE INSERT ON LehrerAbschnittsdaten FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_LEHRERANRECHNUNG_ABSCHNITTE BEFORE INSERT ON LehrerAnrechnung FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_LEHRERENTLASTUNG_ABSCHNITTE BEFORE INSERT ON LehrerEntlastung FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_LEHRERFUNKTIONEN_ABSCHNITTE BEFORE INSERT ON LehrerFunktionen FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_LEHRERMEHRLEISTUNG_ABSCHNITTE BEFORE INSERT ON LehrerMehrleistung FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
delimiter $
CREATE TRIGGER t_INSERT_KURSE_ABSCHNITTE BEFORE INSERT ON Kurse FOR EACH ROW
BEGIN
    DECLARE id INTEGER;
    IF NEW.Jahr IS NOT NULL AND NEW.Abschnitt IS NOT NULL THEN
        SET id := (SELECT Schuljahresabschnitte.ID FROM Schuljahresabschnitte WHERE Schuljahresabschnitte.Jahr = NEW.Jahr AND Schuljahresabschnitte.Abschnitt = NEW.Abschnitt);
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM Schema_AutoInkremente WHERE NameTabelle='Users';
  IF tmpID IS NULL THEN
    SELECT max(ID) INTO tmpID FROM Users;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
  ...
  END IF;
  IF NEW.ID > tmpID THEN
    UPDATE Schema_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle='Users';
  END IF;
END
...
BEGIN
  DECLARE tmpID bigint;
  SELECT MaxID INTO tmpID FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung';
  IF tmpID IS NULL THEN
    SELECT max(ID) INTO tmpID FROM Versetzung;
    IF tmpID IS NULL THEN
      SET tmpID = 0;
    END IF;
  ...
  END IF;
  IF NEW.ID > tmpID THEN
    UPDATE Schema_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle='Versetzung';
  END IF;
END
