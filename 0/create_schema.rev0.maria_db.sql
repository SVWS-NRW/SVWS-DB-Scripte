...
CREATE TABLE K_Lehrer (
  ...
  LPassword varchar(255) COMMENT 'DEPRECATED: Wird für das GS-Modul genutzt (gehashed).', 
  PWAktuell varchar(3) DEFAULT '-;5' COMMENT 'DEPRECATED: Gibt an ob das LPassword geändert wurde oder ob es noch das Initialkennwort ist', 
