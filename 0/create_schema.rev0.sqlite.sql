...
CREATE TRIGGER t_AutoIncrement_INSERT_Users_1 AFTER INSERT ON Users FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Users') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Users')
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Users_2 AFTER INSERT ON Users FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Users') IS NOT NULL
BEGIN
  UPDATE Users SET ID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Users') + 1 WHERE ID = NEW.ID;
  UPDATE Schema_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Users';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Users_3 AFTER INSERT ON Users FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Users') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Users), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Users', coalesce((SELECT max(ID) FROM Users), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Users_4 AFTER INSERT ON Users FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Users), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Users',  NEW.ID);
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Users_5 AFTER INSERT ON Users FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Users') IS NULL
BEGIN
  UPDATE Users SET ID = coalesce((SELECT max(ID) FROM Users), 0) + 1 WHERE ID = NEW.ID;
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Users',  coalesce((SELECT max(ID) FROM Users), 0) + 1);
END;


CREATE TRIGGER t_AutoIncrement_UPDATE_Users_1 AFTER UPDATE ON Users FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Users') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Users')
BEGIN
  UPDATE Schema_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Users';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Users_2 AFTER UPDATE ON Users FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Users') IS NOT NULL
BEGIN
  UPDATE Users SET ID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Users') + 1 WHERE ID = NEW.ID;
  UPDATE Schema_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Users';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Users_3 AFTER UPDATE ON Users FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Users') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Users), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Users', coalesce((SELECT max(ID) FROM Users), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Users_5 AFTER UPDATE ON Users FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Users') IS NULL
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Versetzung_1 AFTER INSERT ON Versetzung FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung')
BEGIN
...
CREATE TRIGGER t_AutoIncrement_INSERT_Versetzung_2 AFTER INSERT ON Versetzung FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') IS NOT NULL
BEGIN
  UPDATE Versetzung SET ID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') + 1 WHERE ID = NEW.ID;
  UPDATE Schema_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Versetzung';
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Versetzung_3 AFTER INSERT ON Versetzung FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Versetzung), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Versetzung', coalesce((SELECT max(ID) FROM Versetzung), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_INSERT_Versetzung_4 AFTER INSERT ON Versetzung FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  ...
	  NEW.ID >= coalesce((SELECT max(ID) FROM Versetzung), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Versetzung',  NEW.ID);
END;


CREATE TRIGGER t_AutoIncrement_INSERT_Versetzung_5 AFTER INSERT ON Versetzung FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') IS NULL
BEGIN
  UPDATE Versetzung SET ID = coalesce((SELECT max(ID) FROM Versetzung), 0) + 1 WHERE ID = NEW.ID;
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Versetzung',  coalesce((SELECT max(ID) FROM Versetzung), 0) + 1);
END;


CREATE TRIGGER t_AutoIncrement_UPDATE_Versetzung_1 AFTER UPDATE ON Versetzung FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') IS NOT NULL AND 
	  NEW.ID > (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung')
BEGIN
  UPDATE Schema_AutoInkremente SET MaxID = NEW.ID WHERE NameTabelle = 'Versetzung';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Versetzung_2 AFTER UPDATE ON Versetzung FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') IS NOT NULL
BEGIN
  UPDATE Versetzung SET ID = (SELECT MaxID FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') + 1 WHERE ID = NEW.ID;
  UPDATE Schema_AutoInkremente SET MaxID = MaxID + 1 WHERE NameTabelle = 'Versetzung';
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Versetzung_3 AFTER UPDATE ON Versetzung FOR EACH ROW
	WHEN NEW.ID >= 0 AND 
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') IS NULL AND
	  NEW.ID < coalesce((SELECT max(ID) FROM Versetzung), 0)
BEGIN
  INSERT INTO Schema_AutoInkremente(NameTabelle, MaxID) VALUES ('Versetzung', coalesce((SELECT max(ID) FROM Versetzung), 0));
END;
...
CREATE TRIGGER t_AutoIncrement_UPDATE_Versetzung_5 AFTER UPDATE ON Versetzung FOR EACH ROW
	WHEN NEW.ID < 0 AND
	  (SELECT max(MaxID) FROM Schema_AutoInkremente WHERE NameTabelle='Versetzung') IS NULL
BEGIN
